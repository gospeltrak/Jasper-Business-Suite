...
const dashboardStaff = fs.readFileSync('src/modules/staff/DashboardStaff.tsx', 'utf8');
const dashboardSettings = fs.readFileSync('src/modules/settings/DashboardSettings.tsx', 'utf8');
const loginPage = fs.readFileSync('src/modules/auth/LoginPage.tsx', 'utf8');
const login = fs.readFileSync('src/modules/auth/LoginPage.tsx', 'utf8');
const admin = fs.readFileSync('src/modules/platform-admin/components/SuperSaaSAdminView.tsx', 'utf8');
...
const notificationContext = fs.readFileSync('src/shared/contexts/JasperNotificationContext.tsx', 'utf8');
const notificationSettings = fs.readFileSync('src/modules/notifications-settings/DashboardNotificationsSettings.tsx', 'utf8');
const platformNotificationsMigration = fs.readFileSync('supabase/migrations/20260814000100_platform_notifications.sql', 'utf8');
const statusRequests = fs.readFileSync('src/modules/platform-admin/components/SaaSStatusAndRequests.tsx', 'utf8');
const pwaInstallBanner = fs.readFileSync('src/shared/components/PWAInstallBanner.tsx', 'utf8');
const landingBundle = fs.readFileSync('public/orvix-landing/app.js', 'utf8');
const landingPage = fs.readFileSync('src/modules/landing/LandingPage.tsx', 'utf8');
const webEditor = fs.readFileSync('src/modules/platform-admin/components/SaaSWebEditor.tsx', 'utf8');
...
const systemErrorPage = fs.readFileSync('src/shared/components/SystemErrorPage.tsx', 'utf8');
const appErrorBoundary = fs.readFileSync('src/shared/components/AppErrorBoundary.tsx', 'utf8');
const dashboardErrorBoundary = fs.readFileSync('src/shared/components/DashboardScreenErrorBoundary.tsx', 'utf8');
