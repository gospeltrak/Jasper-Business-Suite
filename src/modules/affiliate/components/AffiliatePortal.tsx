...
import AffiliateAgentDesk from "./AffiliateAgentDesk";
...
export default function AffiliatePortal({ onNavigate, forcedRole }: AffiliatePortalProps) {
  ...
  const downloadCreative = (title: string, size: string, promo: string) => {
    ...
    if (size === "728x90") {
      ...
      ctx.fillStyle = "#64748b";
      ctx.font = "12px sans-serif";
      ctx.fillText("Visit Orvix signup screen", 30, 650);
    }
              ...
              {portalRole === 'partner' ? (
                <>
                  <div className="inline-flex items-center space-x-2 bg-amber-500/10 text-amber-400 px-3.5 py-1.5 rounded-full border border-amber-500/15 text-xs font-mono">
                    ...
                    <span>Orvix Partner Program</span>
                  </div>
                  ...
                  <p className="text-slate-400 text-sm sm:text-base leading-relaxed font-light">
                    As a Orvix Partner (Super Affiliate Agent), you build and manage your own team of affiliates across Tanzania and East Africa. You earn{" "}
                ...
                <>
                  <div className="inline-flex items-center space-x-2 bg-emerald-500/10 text-emerald-400 px-3.5 py-1.5 rounded-full border border-emerald-500/15 text-xs font-mono">
                    <Sparkles className="w-3.5 h-3.5" />
                    <span>Orvix Affiliate Program</span>
                  </div>
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight">
                  ...
                  <p className="text-slate-400 text-sm sm:text-base leading-relaxed font-light">
                    Join Tanzania and East Africa's fastest-growing retail suite. Recommend Orvix to shop owners and Pharmacy owners. For every monthly subscription they complete, you receive{" "}
              ...
              <div className="w-full max-w-md mx-auto bg-slate-900/80 border border-slate-800 p-8 rounded-3xl shadow-2xl backdrop-blur-md space-y-7">
                ...
                <div className="text-center space-y-2">
                  ...
                  <div className={`inline-flex p-3 rounded-2xl border items-center justify-center mb-1 ${portalRole === 'partner' ? 'bg-amber-500/10 border-amber-500/20' : 'bg-emerald-500/10 border-emerald-500/20'}`}>
                    <img src="/jb-logo.png" alt="Orvix" className="w-10 h-10 object-contain" />
                  </div>
                        ...
                        <div className="p-4 bg-slate-950 text-slate-400 text-[11px] rounded-xl border border-slate-850/60 leading-relaxed font-sans space-y-2">
                          ...
                          <p className="italic font-light">
                            "Anza kurahisisha hesabu za biashara yako leo kwa
	                            kutumia Orvix POS inayosave data moja kwa moja cloud!
                ...
                const ALL_SESSIONS_MATERIALS: SessionMaterial[] = [
                  {
                    id: "doc-1",
                    title:
                      "Orvix POS System Operator Quick-Start Handbook (v2.4)",
                  ...
                  ...tutorialLibrary.map((tutorial) => ({
                    ...
                    desc: tutorial.description || tutorial.link || tutorial.fileName || "Tutorial from Orvix admin.",
                  ...
                  <div className="border-t border-slate-800 pt-4 space-y-4">
                            ...
                            return (
                              <div key={sspAd.id} className="rounded-xl border border-slate-800 bg-slate-950 p-3 space-y-3">
                                <div className="relative overflow-hidden rounded-lg border border-slate-800 bg-slate-900" style={{ aspectRatio: previewRatio }}>
                                  ...
                                  {isVisual && !isVideo && (
                                    <img src={sspAd.assetData} alt={sspAd.title || "Orvix ad material"} className="h-full w-full object-cover" />
                                  )}
                                  {!isVisual && (
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                  ...
                                  {sspAd.assetData ? (
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => downloadCreative(`Orvix SSP ${sspAd.title} Ad banner`, sspAd.size, activeAffiliate?.promoCode || "")}
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            if (sspMatch) sizeStr = sspMatch.size;
                              ...
                              sizeStr = "9:16";
                            downloadCreative(
                              `Orvix ${sspMatch ? "SSP " + sspMatch.title : activeCreativeTab} Ad banner`,
                              sizeStr,
                              activeAffiliate?.promoCode || "",
                            );
                          }}
                    ...
                    <div className="bg-slate-950 p-3 rounded-lg border border-slate-850 text-xs text-slate-400 space-y-1.5">
                      ...
                      <p className="italic text-[11px] leading-relaxed">
                        ...
                        mgahawa? Orvix ndio operating system uliyokuwa
