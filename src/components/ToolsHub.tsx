...
export default function ToolsHub({ onNavigate, isDark, onToggleTheme }: ToolsHubProps) {
  ...
  const t = {
    en: {
      title: 'Orvix Premium Business Tools',
      ...
      scaleDesc: 'In Orvix systems, all store catalogs should project pristine clean 500x500 pixel isolated dimensions. Drop your file here to scale & clean simultaneously.',
    ...
    sw: {
      ...
      scaleDesc: 'Kwenye mfumo wa Orvix, picha zote za bidhaa lazima ziwe na vipimo sawa vya saizi 500x500 ili katalogi ipendeze vizuri.',
    ...
    fr: {
      title: 'Outils Professionnels Premium Orvix',
      ...
      scaleDesc: 'Dans les systèmes Orvix, tous les catalogues de magasins doivent afficher des images nettoyées au format carré standard de 500x500 pixels. Déposez votre fichier ici pour adapter.',
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-sm font-bold tracking-tight uppercase flex items-center gap-2">
                ...
                Orvix <span className="text-emerald-500 font-extrabold font-mono">Tools</span>
              </h1>
