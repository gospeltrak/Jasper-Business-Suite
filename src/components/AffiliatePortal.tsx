                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      ...
                      sub-accounts instantly in our Super SaaS platform ledger.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/25 p-4 rounded-2xl flex items-start space-x-3 text-xs text-amber-200">
              ...
              <div className="space-y-1 font-light">
                ...
                <p className="leading-relaxed">
                  ...
                  generated earnings tax-free under present sandbox provisions.
                </p>
              </div>
            </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-850 flex flex-col justify-center">
                          ...
                          <div className="text-[9px] text-slate-500 mt-2 leading-tight">
                            Total volume generated by your network.
                          </div>
                        </div>
                  ...
                  <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="relative font-sans">
                      ...
                      <input
                        ...
                        placeholder="Search downline affiliates by Name, Email address, Wallet Phone or Promo Coupon..."
                ...
                const ALL_SESSIONS_MATERIALS = [
                  {
                    ...
                    desc: "A complete playbook explaining offline sales synchronization, thermal printer connection, cashier shifts, tax settings, and inventory alerts.",
                    category: "guide",
                    fileSize: "4.8 MB",
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          placeholder="Search document sessions, playbooks and tutorials..."
                  ...
                  >
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        placeholder="Write message, training directions, payout updates or guidelines..."
                    ...
                    <div className="bg-slate-950/40 p-4 rounded-xl border border-slate-850 space-y-3">
                      ...
                      <p className="text-[9.5px] leading-relaxed text-slate-500 flex items-start space-x-1.5 font-sans font-light">
                        ...
                        <span>
                          ...
                          live graphical ad with your automatically tracked
                  ...
                  {claimSuccess ? (
                    <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg space-y-2 text-center text-xs animate-fade-in text-emerald-400">
                      ...
                      <p className="text-[10px] text-slate-400">
                        ...
                        in the Platform Ledger for instant auditing.
                      </p>
                      <button
                        type="button"
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <textarea
                          ...
                          placeholder="Provide invoice, date, shop names, missing conversions details, exact wallet info, or any relevant details..."
                          rows={3}
                      ...
                      if (list.length === 0) {
                        return (
                          <div className="text-center py-8 text-[11px] text-slate-500 font-sans italic font-light">
                            No active disputes submitted. Your account ledger is
                ...
                <div className="p-4 bg-slate-900/60 border border-slate-850 rounded-xl flex flex-col md:flex-row gap-4 items-start md:items-center justify-between text-xs font-sans">
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-300 leading-normal max-w-xl">
                      ...
                      ledger displays active sub-affiliate payout numbers, their
