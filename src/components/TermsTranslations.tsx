...
// ─── PARTNER TERMS (English — favours Orvix/owner) ───────────────────────
  ...
  return (
    <div className="space-y-5 text-[11px] text-slate-300 leading-relaxed">
      <p className="font-black text-amber-400 text-sm border-b border-slate-700 pb-2 uppercase tracking-wider">
        Orvix — Partner (Super Affiliate Agent) Agreement
      </p>
      ...
      <div className="space-y-2">
        ...
        <p>
          You are engaged by the Company as an <strong className="text-amber-400">independent contractor only</strong>. Nothing in this Agreement shall create an employment, partnership, agency, joint venture, or any other legal relationship between you and Orvix. You are NOT an employee of the Company. You are not entitled to any employment benefits, salary, pension, social security, paid leave, sick pay, or any other employment rights under the <em>Employment and Labour Relations Act, Cap. 366 (Tanzania)</em>.
        </p>
        <p>
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1 pl-2">
          <li><strong className="text-amber-400">15% recurring commission</strong> on each monthly subscription payment made by businesses you directly referred to Orvix, as long as that business remains an active paying subscriber.</li>
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1 pl-2">
          <li>You may <strong className="text-white">not</strong> make promises or representations about Orvix's products, pricing, or commissions that differ from the official terms published by the Company.</li>
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1 pl-2">
          ...
          <li>Making false, misleading, or defamatory statements about Orvix or its competitors.</li>
          ...
          <li>Impersonating Orvix staff or claiming to be an official representative of the Company without written authorisation.</li>
        </ul>
      </div>
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1 pl-2">
          ...
          <li>Terminate your Partner account immediately and without notice if you breach any term of this Agreement, engage in fraud, or cause reputational harm to Orvix.</li>
        ...
        <p>
          Upon termination for any reason, you must immediately cease using Orvix branding, promotional materials, and any content provided by the Company.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p>
          All Orvix branding, logos, marketing materials, software, and content remain the exclusive intellectual property of the Company. You are granted a limited, non-exclusive, revocable licence to use Orvix's promotional materials solely for the purpose of referring customers to Orvix. You may not modify, reproduce, or commercialise any Company materials without prior written consent.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p>
          You agree to keep confidential all non-public information about Orvix's business, technology, customer data, pricing, and internal operations that you become aware of through your participation in the Partner Program. This obligation survives termination of this Agreement for a period of <strong className="text-white">3 years</strong>.
        </p>
      </div>
...
export function renderTermsContent(lang: string, portalRole?: string) {
    ...
    return (
      <div className="space-y-4">
        <p className="font-bold text-amber-400 text-sm border-b border-slate-800 pb-2">
          MASHARTI & VIGEZO VYA Washirika wa Orvix
        </p>
        ...
        <p>Unawajibika kutoa NIDA, TIN na taarifa za malipo zilizo sahihi. Orvix inaweza kuchelewesha, kukataa au kusimamisha malipo pale kuna hitilafu, taarifa za uongo, uchunguzi wa udanganyifu au matakwa ya kisheria.</p>
        <p className="font-bold text-slate-100 text-[13px] pt-2">Matumizi ya Promo Materials na Matangazo</p>
        <p>Unaweza kutumia flyers, video, captions, banners na nyenzo rasmi zinazotolewa na Orvix kwa lengo la kutangaza mfumo. Huruhusiwi kubadilisha maana ya matangazo, kutoa ahadi zisizo rasmi, kusema wewe ni mfanyakazi wa Orvix bila ruhusa, au kutangaza kwa njia inayovunja maadili, sheria, faragha au usalama wa watumiaji.</p>
        <p className="font-bold text-slate-100 text-[13px] pt-2">Mambo Yaliyokatazwa</p>
        <p>Ni marufuku kujisajili mwenyewe kwa kutumia code yako, kutumia accounts bandia, kuiba leads za affiliate mwingine, kutumia spam, kudanganya bei/kifurushi, kudai uhakika wa mapato, kuharibu jina la Orvix, au kukusanya taarifa za wateja bila ridhaa halali.</p>
        <p className="font-bold text-slate-100 text-[13px] pt-2">Faragha na Ulinzi wa Data</p>
        <p>Kwa kusajiliwa unakubali Orvix kuchakata jina, simu, NIDA, TIN, taarifa za malipo, referral code na shughuli zako za affiliate kwa ajili ya kuendesha program, kuzuia udanganyifu, kulipa kamisheni na kutimiza sheria. Orvix itazingatia Sheria ya Ulinzi wa Taarifa Binafsi, 2022 ya Tanzania, lakini wewe pia unawajibika kulinda data za wateja unaowaleta.</p>
        <p className="font-bold text-slate-100 text-[13px] pt-2">Haki za Orvix na Kikomo cha Dhima</p>
        <p>Orvix inaweza kubadilisha commissions, rules, promo materials, payout thresholds au kusimamisha program kwa taarifa inayofaa. Akaunti inaweza kusimamishwa mara moja kwa udanganyifu, kuvunja sheria au kuhatarisha jina la kampuni. Dhima ya Orvix haitazidi kamisheni halali uliyolipwa katika miezi mitatu iliyopita kabla ya madai.</p>
  ...
  if (lang === "fr") {
    return (
      <div className="space-y-4">
        ...
        <p>Vous recevrez une commission récurrente de 15% sur toutes les factures d'abonnement mensuelles payées en totalité par les commerces que vous parrainez sur Orvix.</p>
        <p className="font-bold text-slate-100 text-[13px] pt-2">3. DISPOSITIONS FISCALES ET CONFORMITÉ (TRA)</p>
        <p>Tous les paiements effectués dans le cadre du programme d'affiliation Orvix sont soumis aux lois fiscales locales de la Tanzania Revenue Authority (TRA).</p>
      </div>
    );
  }
  ...
  if (lang === "ar") {
    return (
      <div className="space-y-4 text-right" dir="rtl">
        ...
        <p className="text-right">بالتسجيل في شبكة شركاء Orvix، فإنك تقر بأن عمرك لا يقل عن 18 عامًا وتتمتع بإقامة قانونية في تنزانيا أو شرق إفريقيا.</p>
        <p className="font-bold text-slate-100 text-[13px] pt-2 text-right">2. هيكل الأرباح والعمولات</p>
        <p className="text-right">ستتلقى عمولة متكررة بنسبة 15٪ على جميع فواتير الاشتراك الشهري المدفوعة بالكامل من التجار الذين تمت إحالتهم إلى Orvix.</p>
  ...
  return (
    <div className="space-y-4">
      ...
      <p>You shall receive a 15% recurring commission on all monthly subscription invoices paid in full by retail, wholesale, or pharmacy operators whom you refer to Orvix. No commissions shall accrue on cancelled accounts, test accounts, credit balances, or transactions disputed for suspicious charge activity.</p>
      ...
      <p>Commission is calculated only on settled revenue actually received by Orvix. Free trials, refunds, chargebacks, disputed payments, internal demos, fraudulent tenants, self-referrals, duplicate tenants and accounts registered for artificial commission generation do not qualify.</p>
      ...
      <p>You remain responsible for personal tax filings, truthful registration information and keeping payout details current. Orvix may delay, reverse or withhold payment during fraud review, legal review, technical reconciliation or where supplied data is incomplete.</p>
      <p className="font-bold text-slate-100 text-[13px] pt-2">Marketing Materials, Ads & Brand Rules</p>
      <p>Orvix may provide flyers, videos, banners, captions, links, codes and promotional materials. You may use them only to promote Orvix honestly and lawfully. You may not alter their meaning, make unofficial promises, impersonate Orvix staff, run misleading campaigns, or publish promotions that violate public morals, privacy, consumer safety, advertising law, cyber law or platform rules.</p>
      <p className="font-bold text-slate-100 text-[13px] pt-2">Compliance & Prohibited Practices</p>
      <p>Affiliates are strictly forbidden from executing self-referrals, creating fake accounts, making misleading advertisements, or impersonating Orvix staff. In any such instance, your user account will be locked and all accrued balances forfeited with no appeal.</p>
      <p>Spam, unauthorized scraping, collecting customer data without consent, bribing staff, stealing another affiliate's lead, reselling account access, tampering with referral links, defaming Orvix, or promising guaranteed profits are prohibited.</p>
      <p className="font-bold text-slate-100 text-[13px] pt-2">Privacy & Data Protection</p>
      <p>By registering, you consent to Orvix collecting and processing your name, phone, NIDA, TIN, payout details, referral code, activity logs and commission records for operating the affiliate program, paying commissions, preventing fraud, enforcing rules and complying with law. Orvix observes the Tanzania Personal Data Protection Act, 2022. You must also protect customer and tenant data you handle.</p>
      <p className="font-bold text-slate-100 text-[13px] pt-2">Company Rights, Suspension & Limitation of Liability</p>
      <p>Orvix may amend commission rates, payout thresholds, promotional assets, program rules or eligibility requirements with reasonable notice through the platform. Orvix may immediately suspend or terminate an account for fraud, abuse, breach, reputational harm, unlawful marketing or security risk. Orvix's maximum liability to an affiliate is limited to lawful commissions paid to that affiliate in the three months before the claim.</p>
