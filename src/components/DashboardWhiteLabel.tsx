        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-slate-400 text-sm leading-relaxed font-light">
              Transform Ndiva Suite into a premium, white-labeled inventory and Point of Sale module integrated seamlessly into your client&apos;s existing site. Sell website design services with a fully branded ERP engine running silently in the background!
            </p>
          </div>
              ...
              <div className="pt-2 border-t border-slate-100 space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-[10px] text-slate-400 font-light block">Hide any references to &quot;Ndiva Suite&quot;</span>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                  ...
                  <div className="text-right text-[10px] font-mono font-medium text-slate-400">
                    {hideJasperBranding ? (
                      ...
                      <span>Engine: <span className="text-slate-600 font-bold">Ndiva Suite Enterprise</span></span>
                    )}
                  </div>
                </div>
                    ...
                    <div className="space-y-4 my-auto">
                      <div className="max-w-md mx-auto space-y-3 text-center">
                        ...
                        <p className="text-[11px] text-slate-450 leading-relaxed font-light">
                          This represents the white-labeled register till loaded specifically for your client counters. Products, pricing catalogs, promos and cash receipts registered here bypass any Ndiva branding, displaying only client colors (<span className="font-mono font-bold" style={{ color: primaryColor }}>{primaryColor}</span>) flawlessly.
                        </p>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-3 bg-emerald-50/40 border border-emerald-100/80 rounded-2xl text-left flex items-start space-x-2">
                        ...
                        <p className="text-[10px] leading-relaxed text-slate-600">
                          <strong>Automatic Locks Enforcement:</strong> Under this White-Label structure, if the end-customer fails to renew their custom designer subscription, you can disable their custom embedded portal instantly via your primary Ndiva panel.
                        </p>
                      </div>
                    </div>
                  )}
