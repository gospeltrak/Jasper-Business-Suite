...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    tagline: "Ndiva helps you run and grow your business.",
    builtFor: "Built For:",
    retail: "Retail Shops",
    ...
    lucyDesc: "Lucy shows you how to use Ndiva and answers simple business questions.",
    featLucyTitle: "Lucy AI Business Assistant",
    featLucyDesc: "Ask Lucy about Ndiva, sales, stock, costs, and business reports.",
  ...
  sw: {
    ...
    aboutDesc: "Ndiva huhifadhi mauzo, bidhaa na mipangilio yako salama mtandaoni.",
    ...
    mustafaSay: "Tulihitaji kumbukumbu safi kwenye vifaa vyote. Ndiva imeweka mauzo na bidhaa zetu sawa.",
  ...
  fr: {
    ...
    aboutDesc: "Ndiva garde vos ventes, votre stock et vos réglages en sécurité en ligne.",
